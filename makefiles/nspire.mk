...
PLATFORM_OPTIONS:=-D__NSPIRE__ --target=armv5tej-unknown-none-eabi -mcpu=arm926ej-s 
...
LD:=ld.lld-11
LD_FLAGS:=-g -T $(LINKER_SCRIPTS_DIR)/nspire.ld -fuse-ld=lld -static -ffreestanding -O0 -nostdlib $(PLATFORM_OPTIONS)
