...
PLATFORM_OPTIONS:=-D__GAMEBOY_ADVANCED__ --target=armv4t-unknown-none-eabi -mcpu=arm7tdmi -mthumb
...
LD:=ld.lld-11
LD_FLAGS:=-g -T $(LINKER_SCRIPTS_DIR)/gba.ld -fuse-ld=lld -static -ffreestanding -O0 -nostdlib $(PLATFORM_OPTIONS)
