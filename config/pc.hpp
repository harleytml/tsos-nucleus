...
#define VIDEO_DRIVERS { MDA_driver(),  CGA_driver(),  EGA_driver(),  VGA_driver()}
#define INPUT_DRIVERS { XT_KEYBOARD_driver(),  AT_KEYBOARD_driver()}
#define DISK_DRIVERS { CD_driver()}
#define SERIAL_DRIVERS { RS232_driver()}
#define BOOT_DRIVERS { GRUB2_driver()}
