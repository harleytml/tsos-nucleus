...
#define VIDEO_DRIVERS { GBA_SCREEN_driver()}
#define INPUT_DRIVERS { GBA_GAMEPAD_driver()}
#define DISK_DRIVERS { GBA_CARTRIDGE_driver()}
#define SERIAL_DRIVERS { GBA_IO_PORT_driver()}
#define BOOT_DRIVERS { GBA_BOOT_driver()}
