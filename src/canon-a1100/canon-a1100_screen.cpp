...
bool CANON_A1100_SCREEN_quark::detectsystem(void) { return true; }
...
void CANON_A1100_SCREEN_quark::drawpx(uint16_t pos_x, uint16_t pos_y,
    const Color& c) { }

void CANON_A1100_SCREEN_quark::putchar(uint16_t posx, uint16_t posy, char c,
    const Color& bc, const Color& fc) { }

uint16_t CANON_A1100_SCREEN_quark::getscreenwidth(void) { return 0; }

uint16_t CANON_A1100_SCREEN_quark::getscreenheight(void) { return 0; }
