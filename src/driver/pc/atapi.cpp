...
ATAPI_quark::IDEChannelRegisters::IDEChannelRegisters() : base(0), ctrl(0), bmide(0), nIEN(0)
{
}

ATAPI_quark::IDE_device::IDE_device()
    : Reserved(0), Channel(0), Drive(0), Type(0), Signature(0), Capabilities(0), CommandSets(0), Size(0)
{
