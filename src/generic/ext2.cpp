...
EXT2_quark::EXT2_quark(void) { name = "EXT2"; }
...
char** EXT2_quark::readdir(char* path) { return nullptr; }
...
char* EXT2_quark::read(File file) { return nullptr; }

void EXT2_quark::write(File file, char* data) { }

char* EXT2_quark::readfile(char* path) { return nullptr; }

void EXT2_quark::writefile(char* path, char* data) { }

void EXT2_quark::appendfile(char* path, char* data) { }

bool EXT2_quark::exists(char* path) { return false; }

bool EXT2_quark::isfilenamevalid(char* name) { return true; }
