...
char** FAT32_quark::readdir(char* path) { return nullptr; }
...
char* FAT32_quark::read(File file) { return nullptr; }

void FAT32_quark::write(File file, char* data) { }

char* FAT32_quark::readfile(char* path) { return nullptr; }

void FAT32_quark::writefile(char* path, char* data) { }

void FAT32_quark::appendfile(char* path, char* data) { }

bool FAT32_quark::exists(char* path) { return false; }

bool FAT32_quark::isfilenamevalid(char* name) { return true; }
