...
UDF_quark::UDF_quark(void) { name = "Universal Disk Filesystem"; }
...
char** UDF_quark::readdir(char* path) { return nullptr; }
...
char* UDF_quark::read(File file) { return nullptr; }

void UDF_quark::write(File file, char* data) { }

char* UDF_quark::readfile(char* path) { return nullptr; }

void UDF_quark::writefile(char* path, char* data) { }

void UDF_quark::appendfile(char* path, char* data) { }

bool UDF_quark::exists(char* path) { return false; }

bool UDF_quark::isfilenamevalid(char* name) { return true; }
