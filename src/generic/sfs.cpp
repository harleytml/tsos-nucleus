...
SFS_quark::SFS_quark(void) { name = "Simple File System"; }
...
char** SFS_quark::readdir(char* path) { return nullptr; }
...
char* SFS_quark::read(File file) { return nullptr; }

void SFS_quark::write(File file, char* data) { }

char* SFS_quark::readfile(char* path) { return nullptr; }

void SFS_quark::writefile(char* path, char* data) { }

void SFS_quark::appendfile(char* path, char* data) { }

bool SFS_quark::exists(char* path) { return false; }

bool SFS_quark::isfilenamevalid(char* name) { return true; }
