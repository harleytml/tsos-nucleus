...
void RPI3_UART_quark::reset(void)
{
	...
	tsos->io.out32(static_cast<uint32_t>(registers::GPPUDCLK0), (1 << 14) |
																																	(1 << 15));
	delay(150);
	...
	tsos->io.out32(static_cast<uint32_t>(registers::UART0_LCRH), (1 << 4) |
																																	 (1 << 5) |
																																	 (1 << 6));

	// Mask all interrupts.
	tsos->io.out32(static_cast<uint32_t>(registers::UART0_IMSC), (1 << 1) |
																																	 (1 << 4) |
																																	 (1 << 5) |
																																	 (1 << 6) |
																																	 (1 << 7) |
	...
	tsos->io.out32(static_cast<uint32_t>(registers::UART0_CR), (1 << 0) |
																																 (1 << 8) |
																																 (1 << 9));
}
