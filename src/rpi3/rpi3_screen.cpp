...
void RPI3_SCREEN_quark::putchar(uint16_t posx, uint16_t posy, char c,
    const Color& bc, const Color& fc) { }

uint16_t RPI3_SCREEN_quark::getscreenwidth(void) { return 0; }

uint16_t RPI3_SCREEN_quark::getscreenheight(void) { return 0; }
