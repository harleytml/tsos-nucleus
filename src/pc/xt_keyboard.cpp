...
XT_KEYBOARD_quark::XT_KEYBOARD_quark(void) { name = "PC/XT Keyboard"; }
...
bool XT_KEYBOARD_quark::isshiftpressed(void) { return false; }

bool XT_KEYBOARD_quark::isaltpressed(void) { return false; }

bool XT_KEYBOARD_quark::isctrlpressed(void) { return false; }
