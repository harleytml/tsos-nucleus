...
AT_KEYBOARD_quark::AT_KEYBOARD_quark(void) { name = "PC/AT Keyboard"; }
...
bool AT_KEYBOARD_quark::isshiftpressed(void) { return false; }

bool AT_KEYBOARD_quark::isaltpressed(void) { return false; }

bool AT_KEYBOARD_quark::isctrlpressed(void) { return false; }
