...
bool NSPIRE_CM_UART_quark::detectsystem(void) { return true; }
...
bool NSPIRE_CM_UART_quark::isdevicereadytoreceive(void) { return false; }

void NSPIRE_CM_UART_quark::outbyte(uint8_t byte) { }

uint8_t NSPIRE_CM_UART_quark::inbyte(void) { return 0; }
