...
void NSPIRE_CM_SCREEN_quark::drawpx(uint16_t pos_x, uint16_t pos_y, const Color &c)
{
}

void NSPIRE_CM_SCREEN_quark::putchar(uint16_t posx, uint16_t posy, char c, const Color &bc, const Color &fc)
{
}
