...
bool NSPIRE_CM_DISK_quark::detectsystem() { return true; }

void NSPIRE_CM_DISK_quark::reset(void) { }

void NSPIRE_CM_DISK_quark::getbytes(uint8_t* buffer, uint16_t offset,
    uint8_t len) { }

uint16_t NSPIRE_CM_DISK_quark::getsectorsize(void) { return 0; }
