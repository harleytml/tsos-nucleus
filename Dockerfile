...
RUN apt -y --no-install-recommends install git mtools dos2unix python3 wget xz-utils grub2 grub-pc-bin xorriso cmake python3-pip dosfstools qemu-system-i386 qemu-system-arm make
