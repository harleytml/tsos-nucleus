...
$(OUTPUT_DIR)/kernel.img: $(BUILD_DIR)/kernel.o $(BUILD_DIR)/bootloader.o
:$(LD) $(LD_FLAGS) -o $@ $(BUILD_DIR)/kernel.o $(BUILD_DIR)/bootloader.o

$(BUILD_DIR)/kernel.o: $(BUILD_DIR)/current_config.hpp
...
:echo "#define VIDEO_DRIVERS {new DMG_SCREEN_driver}" >> $@
:echo "#define INPUT_DRIVERS {new DMG_GAMEPAD_driver}" >> $@
:echo "#define DISK_DRIVERS {new DMG_CARTRIDGE_driver}" >> $@
:echo "#define SERIAL_DRIVERS {new DMG_IO_PORT_driver}" >> $@
:echo "#define BOOT_DRIVERS {new DMG_BOOT_driver}" >> $@
